...
//	EXPENSE_UTILITIES(Values.EXPENSE_UTILITIES, CashflowType.EXPENSE),
	...
	EXPENSE_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL(Values.EXPENSE_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL, CashflowType.EXPENSE),
	EXPENSE_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL(Values.EXPENSE_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL, CashflowType.EXPENSE),
	...
	APPRECIATION_INTEREST_LIQUID(Values.APPRECIATION_INTEREST_LIQUID, CashflowType.APPRECIATION_LIQUID),
	APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_EMPLOYER(Values.APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_EMPLOYER, CashflowType.APPRECIATION_FIXED),
	APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL(Values.APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL, CashflowType.APPRECIATION_FIXED),
	APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_GOVT(Values.APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_GOVT, CashflowType.APPRECIATION_FIXED),
	APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL(Values.APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL, CashflowType.APPRECIATION_FIXED),

	DEPRECIATION_ADMIN_FEE(Values.DEPRECIATION_ADMIN_FEE, CashflowType.DEPRECIATION_FIXED),
	DEPRECIATION_MANAGEMENT_FEE(Values.DEPRECIATION_MANAGEMENT_FEE, CashflowType.DEPRECIATION_FIXED),
	DEPRECIATION_SALE(Values.DEPRECIATION_SALE, CashflowType.DEPRECIATION_FIXED),
...
//	JE_BALANCE_CLOSING_ASSET_VALUE_UNAVAILABLE_TO_POT(Values.JE_BALANCE_CLOSING_ASSET_VALUE_UNAVAILABLE_TO_POT, CashflowType.JE_BALANCE_CLOSING);
	...
	public static class Values {
		...
		public static final String APPRECIATION_INTEREST_LIQUID = "APPRECIATION_INTEREST_LIQUID";
		public static final String APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_EMPLOYER = "APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_EMPLOYER";
		public static final String APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL = "APPRECIATION_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL";
		public static final String APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_GOVT = "APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_GOVT";
		public static final String APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL = "APPRECIATION_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL";
		...
		public static final String DEPRECIATION_ADMIN_FEE = "DEPRECIATION_ADMIN_FEE";
		public static final String DEPRECIATION_MANAGEMENT_FEE = "DEPRECIATION_MANAGEMENT_FEE";
		...
		public static final String EXPENSE_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL = "EXPENSE_SUPER_CONTRIBUTION_CONCESSIONAL_PERSONAL";
		public static final String EXPENSE_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL = "EXPENSE_SUPER_CONTRIBUTION_NON_CONCESSIONAL_PERSONAL";
